...
namespace CheapSkies.View.View
{
    public class UserInterface : IUserInterface
    {
        ...
        public void Display(ReservationBase reservation)
        {
            Console.WriteLine($"{reservation.PNR} \t {reservation.AirlineCode} \t\t {reservation.FlightNumber} \t\t {reservation.ArrivalStation} \t\t\t " +
                            $"{reservation.DepartureStation} \t\t\t {reservation.FlightDate} \t {reservation.NumberOfPassenger}");
        }
